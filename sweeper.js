...
var _user$project$Styles$Mine = {ctor: 'Mine'};
var _user$project$Styles$Discovered = {ctor: 'Discovered'};
var _user$project$Styles$Cell = {ctor: 'Cell'};
var _user$project$Styles$Row = {ctor: 'Row'};
var _user$project$Styles$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'sweeper', _p0));
}(
	{
		ctor: '::',
		_0: A2(
...
var _user$project$Main$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('sweeper');
...
var _user$project$Main$renderMine = A2(
	_elm_lang$html$Html$div,
	{
		...
		_0: _user$project$Main$class(
			{
				ctor: '::',
				_0: _user$project$Styles$Cell,
				_1: {
					ctor: '::',
					_0: _user$project$Styles$Mine,
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
...
var _user$project$Main$showCell = function (cell) {
	return _elm_lang$core$Native_Utils.update(
		cell,
		{state: _user$project$Main$Discovered});
};
var _user$project$Main$revealMines = _eeue56$elm_flat_matrix$Matrix$map(
	function (cell) {
		return _user$project$Main$isMine(cell) ? _user$project$Main$showCell(cell) : cell;
	});
var _user$project$Main$Flagged = {ctor: 'Flagged'};
var _user$project$Main$isFlag = function (cell) {
...
var _user$project$Main$countNeighbouringFlags = F3(
	function (x, y, field) {
		return _elm_lang$core$List$length(
			A2(
				_elm_lang$core$List$filter,
				_user$project$Main$isFlag,
				A3(_eeue56$elm_flat_matrix$Matrix_Extra$neighbours, x, y, field)));
	});
var _user$project$Main$hasWronglyFlaggedNeighbours = F3(
	function (x, y, field) {
		return A2(
			_elm_lang$core$List$any,
			function (cell) {
				return A2(
					...
					_user$project$Main$isFlag(cell),
					_user$project$Main$isMine(cell));
			},
			A3(_eeue56$elm_flat_matrix$Matrix_Extra$neighbours, x, y, field));
	});
var _user$project$Main$Potential = {ctor: 'Potential'};
var _user$project$Main$initCell = function (mine) {
	return {state: _user$project$Main$Potential, mine: mine, neighbours: 0};
};
var _user$project$Main$isPotential = function (cell) {
	return _elm_lang$core$Native_Utils.eq(cell.state, _user$project$Main$Potential);
};
var _user$project$Main$discover = F3(
	function (x, y, field) {
...
var _user$project$Main$toggleFlagState = function (cell) {
	var newState = _user$project$Main$isPotential(cell) ? _user$project$Main$Flagged : _user$project$Main$Potential;
	return _elm_lang$core$Native_Utils.update(
		cell,
		{state: newState});
};
var _user$project$Main$toggleFlag = F3(
	function (x, y, model) {
		var newField = A4(_eeue56$elm_flat_matrix$Matrix$update, x, y, _user$project$Main$toggleFlagState, model.field);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				field: newField,
				flagsLeft: _user$project$Main$countFlagsLeft(newField)
			});
	});
var _user$project$Main$GameOver = {ctor: 'GameOver'};
var _user$project$Main$floodFromCell = F4(
	function (x, y, cell, model) {
		if (_elm_lang$core$Native_Utils.eq(cell.neighbours, 0) || (!_elm_lang$core$Native_Utils.eq(
			cell.neighbours,
			A3(_user$project$Main$countNeighbouringFlags, x, y, model.field)))) {
			return model;
		} else {
			if (A3(_user$project$Main$hasWronglyFlaggedNeighbours, x, y, model.field)) {
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						field: _user$project$Main$revealMines(model.field),
						phase: _user$project$Main$GameOver
					});
			} else {
				var fieldsToDiscover = A2(
					_elm_lang$core$List$map,
					_elm_lang$core$Tuple$first,
					A2(
						_elm_lang$core$List$filter,
	...
	function (x, y, model) {
		...
		if (_p17.ctor === 'Nothing') {
			...
			return _p17._0.mine ? _elm_lang$core$Native_Utils.update(
				...
				model,
				{
					field: A3(_user$project$Main$discover, x, y, model.field)
				});
		}
	});
				...
				_0: _user$project$Main$class(
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Styles$Discovered,
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onDoubleClick(
						A3(_user$project$Main$DoubleClickCell, x, y, cell)),
					_1: {ctor: '[]'}
				}
			},
			{
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				...
				_0: _elm_lang$keyboard$Keyboard$ups(
					function (x) {
						return _elm_lang$core$Native_Utils.eq(x, _user$project$Main$shiftKey) ? _user$project$Main$ReleaseShift : _user$project$Main$NoOp;
					}),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$ClickCell = F2(
	function (a, b) {
		return {ctor: 'ClickCell', _0: a, _1: b};
	});
var _user$project$Main$renderFlagged = F2(
	function (x, y) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _user$project$Main$class(
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Styles$Flagged,
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						A2(_user$project$Main$ClickCell, x, y)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Main$renderPotential = F2(
	function (x, y) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _user$project$Main$class(
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Styles$Potential,
							_1: {ctor: '[]'}
						}
					}),
				_1: {
...
var _user$project$Main$renderCell = F3(
	function (y, x, cell) {
		...
		switch (_p25._0.ctor) {
			...
			case 'Flagged':
				return A2(_user$project$Main$renderFlagged, x, y);
			default:
				return A2(_user$project$Main$renderPotential, x, y);
		}
	});
var _user$project$Main$renderRow = F2(
	function (row, data) {
		return A2(
			...
			A2(
				_elm_lang$core$List$indexedMap,
				A2(_elm_lang$html$Html_Lazy$lazy3, _user$project$Main$renderCell, row),
				_elm_lang$core$Array$toList(data)));
	});
var _user$project$Main$renderField = function (field) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
			...
			function (idx) {
				return A3(
					...
					_user$project$Main$renderRow,
					idx,
					A2(
						_elm_lang$core$Maybe$withDefault,
						_elm_lang$core$Array$empty,
						A2(_eeue56$elm_flat_matrix$Matrix$getRow, idx, field)));
			},
			A2(
				_elm_lang$core$List$range,
				0,
				_eeue56$elm_flat_matrix$Matrix$height(field) - 1)));
};
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _user$project$Main$class(
				{
					ctor: '::',
					_0: _user$project$Styles$Wrapper,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
